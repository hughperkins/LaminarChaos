...
void Mesh :: SetVertices(Vertex *verts)
{
	...
	// modified Hugh Perkins sept 2004 for linux compat
	memcpy(vlist,verts,sizeof(Vertex)*numvertices);
}
...
void Mesh :: SetTriangles(Triangle *tris)
{
	...
	// modified Hugh Perkins sept 2004 for linux compat
	memcpy(tlist,tris,sizeof(Triangle)*numtriangles);
}
